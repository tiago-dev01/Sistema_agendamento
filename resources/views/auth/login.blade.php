...
<link href='http://fonts.googleapis.com/css?family=Lobster:400,300' rel='stylesheet' type='text/css'>
    ...
    <div id="formWrapper">
      <div id="form">
        ...
        <div class="form-item">
          ...
          <p><a href="{{ route('password.request') }}" ><small>Esqueceu sua senha ?</small></a></p>	
        </div>
        <div class="form-item">
        <p class="pull-left"><a href="{{ route('register') }}"><small>Registre-se</small></a></p>
